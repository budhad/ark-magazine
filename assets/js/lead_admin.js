(function($) {
    ...
    function updateOffer(offer, index = 1, lastOffer = false, insertOnly = false) {
    ...
    $(document).ready(function() {
        ...
        $('#create_offers').on('click', function(e){
            ...
            .then(result => {
                if (!result.result) {
                    ...
                    $.each(result.offers, function(index, offer){
                        ...
                        // updateOffer(offer, index, lastOffer, true);
            ...
            // var formData = new FormData();
            // formData.append('action', 'create_all_offers');
            ...
            // .then(result => {
            //     if ( result.result ) {
            //         var text = "Добавлено офферов: " + result.new_offers_id.length;
            //         show_message_admin_plugin('success', text, $(this));
            //     } else {
            //         show_message_admin_plugin('error', result.message, $(this));
            //     }
            // })
            // .catch(err => {
            //     show_message_admin_plugin('error', err);
        ...
        // $('#get_list_platform').on('click', function(e){
        //     e.preventDefault();
        //     var formData = new FormData();
        //     formData.append('action', 'get_list_platform');
        ...
        //     .then( result => {
        //         if ( result.result ) {
        //             show_message_admin_plugin('success', result.message);
